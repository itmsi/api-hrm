...
Sistem ini dikembangkan menjadi API HRM untuk manajemen sumber daya manusia, termasuk kandidat, perusahaan, departemen, dan modul HRM lainnya.

## 🚀 Fitur Utama

- ✅ **HRM Module Support**: Struktur modul siap pakai untuk kandidat dan HRM CRUD
